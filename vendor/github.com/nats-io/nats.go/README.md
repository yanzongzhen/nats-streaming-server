...
[![Go Report Card](https://goreportcard.com/badge/github.com/yanzongzhen/nats.go)](https://goreportcard.com/report/github.com/yanzongzhen/nats.go) [![Build Status](https://travis-ci.org/nats-io/nats.go.svg?branch=master)](http://travis-ci.org/nats-io/nats.go) [![GoDoc](https://godoc.org/github.com/yanzongzhen/nats.go?status.svg)](http://godoc.org/github.com/yanzongzhen/nats.go) [![Coverage Status](https://coveralls.io/repos/nats-io/nats.go/badge.svg?branch=master)](https://coveralls.io/r/nats-io/nats.go?branch=master)

## Installation

```bash
# Go client
go get github.com/yanzongzhen/nats.go/
...
go get github.com/yanzongzhen/nats.go/@latest
go get github.com/yanzongzhen/nats.go/@v1.10.0

# For latest NATS Server, add /v2 at the end
go get github.com/yanzongzhen/nats-server
...
```go
import nats "github.com/yanzongzhen/nats.go"
