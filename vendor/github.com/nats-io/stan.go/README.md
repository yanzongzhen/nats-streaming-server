...
[![GoDoc](https://godoc.org/github.com/yanzongzhen/stan.go?status.svg)](http://godoc.org/github.com/yanzongzhen/stan.go)
...
- Please raise questions/issues via the [Issue Tracker](https://github.com/yanzongzhen/stan.go/issues).

## Installation

```bash
# Go client
go get github.com/yanzongzhen/stan.go/
```
...
go get github.com/yanzongzhen/stan.go/@latest
go get github.com/yanzongzhen/stan.go/@v0.7.0
```

## Basic Usage

```go
import stan "github.com/yanzongzhen/stan.go"
